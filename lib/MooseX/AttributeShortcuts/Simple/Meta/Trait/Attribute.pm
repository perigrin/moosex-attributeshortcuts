package MooseX::AttributeShortcuts::Simple::Meta::Trait::Attribute;
use Moose::Role;
...
package Moose::Meta::Attribute::Custom::Trait::SimpleAttributeShortcuts;

sub register_implementation {
    'MooseX::AttributeShortcuts::Simple::Meta::Trait::Attribute'
}
